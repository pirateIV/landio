...
export default function Navigation() {
	return (
		<div className="fixed inset-x-0 top-0 z-[8] h-auto flex-none">
			<header className="flex h-16 w-full items-center justify-center border-b-2 border-gray-900 backdrop-blur-[2px] will-change-transform">
				<div className="mx-auto flex max-w-[1350px] flex-[1_0_0px] flex-nowrap items-center justify-between px-10">
					...
					<nav className="relative flex size-min flex-none items-center gap-1.5 rounded-[100px] border border-gray-900 px-3 py-1.5">
						{navLinks.map((link) => (
